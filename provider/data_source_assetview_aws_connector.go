...
func dataSourceAssetViewAWSConnector() *schema.Resource {
	return &schema.Resource{
		...
		Read: dataSourceAssetViewAWSConnectorRead,
	}
}

func dataSourceAssetViewAWSConnectorRead(d *schema.ResourceData, m interface{}) error {
